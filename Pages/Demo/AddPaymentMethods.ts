...
import paymentData from "../../testData/addressPage.json"
...
export class Add_New_PaymentMethod{
    readonly page:Page
    ...
    async add_New_PaymentMotheds(){
        ...
        await this.cardNumber.fill("1234567890987654");
        await this.cardHolderName.fill("Hareesh");
        await this.securityCode.fill("1221");
        await this.expMM.selectOption('12');
        await this.expYY.selectOption("2028");
